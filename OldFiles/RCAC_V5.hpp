...
public:
    ...
    void set_RCAC_parameters(double P0_val, double lambda_val, int nf_val, float N1_val);
    void init_RCAC();
...
void RCAC::set_RCAC_parameters(double P0_val, double lambda_val, int nf_val, float N1_val)
{
    P0 = P0_val;
    lambda = lambda_val;
    nf = nf_val;
